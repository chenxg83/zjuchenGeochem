...
$$log10(K)=3.94-677/T-12.39*T/1000$$ 
...
where $H^{cc}_{\theta}$ is the Henry's law constant at *T*$_\theta$ (298.15 K), *T* is the temperature of the dissolution system.
